...
def main():
    ...
    candy_quantity_str = input(str("How many candy bars? "))
    soda_quantity_str = input(str("How many sodas? "))
    gallons_str = input(str("How many gallons of gas? "))
    pounds_str = input(str("How many pounds of deli meat? "))
    lottery_quantity_str = input(str("How many lottery tickets?"))
